...
JOIN → username (during connection)
...
This project clearly demonstrates Transport Layer functionality without relying on high-level networking libraries, making it suitable for:
